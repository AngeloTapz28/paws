...
<style>
    ...
    /* ── App number link ── */
    .app-number { font-weight: 700; color: var(--coral); font-size: .85rem; text-decoration: none; transition: color .15s; }
    ...
    <form method="GET" class="row g-2 align-items-center">
        ...
        <div class="col-sm-3 col-md-2">
            <select name="status" class="form-select form-select-sm">
                ...
                @foreach(['pending','submitted','reviewing','under_review','interview','approved','rejected','completed','withdrawn','returned'] as $s)
        ...
        <div class="col-auto d-flex gap-2">
            ...
            <a href="{{ route('staff.applications.index') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
        </div>
    </form>
</div>
            ...
            <tbody>
                ...
                <tr class="app-row" data-index="{{ $i }}">
                    ...
                    <td style="padding-left:1.25rem;">
                        <a href="{{ route('staff.applications.show', $app) }}" class="app-number">
